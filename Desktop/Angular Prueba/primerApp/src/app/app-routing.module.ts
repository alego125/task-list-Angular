...
import { ThankYouPageModule } from './pages/checkout/thank-you-page/thank-you-page.module';
...
//Colocamos una redireccion para que cuando la ruta hacia donde queramos ir sea vacia entonces nos redirija a la pagina de inicio
const routes: Routes = [
  { path: '', redirectTo: '/products', pathMatch:'full' },
  { path: 'products', loadChildren: () => import('./pages/products/products.module').then(m => m.ProductsModule) },
  { path: 'checkout', loadChildren: () => import('./pages/checkout/checkout.module').then(m => m.CheckoutModule) },
  { path: 'checkout/thank-you-page', loadChildren: () => import('./pages/checkout/thank-you-page/thank-you-page.module').then(m => m.ThankYouPageModule) },
